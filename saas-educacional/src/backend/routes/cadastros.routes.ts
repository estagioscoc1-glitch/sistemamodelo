...
import { studentSchema, courseSchema, classSchema } from '../validators';
...
router.post('/cursos', validateBody(courseSchema), (req, res, next) => cursosController.create(req, res, next));
router.get('/cursos/:id', (req, res, next) => cursosController.getById(req, res, next));
router.put('/cursos/:id', validateBody(courseSchema), (req, res, next) => cursosController.update(req, res, next));
...
router.post('/turmas', validateBody(classSchema), (req, res, next) => turmasController.create(req, res, next));
router.get('/turmas/:id', (req, res, next) => turmasController.getById(req, res, next));
router.put('/turmas/:id', validateBody(classSchema), (req, res, next) => turmasController.update(req, res, next));
...
router.post('/alunos', validateBody(studentSchema), (req, res, next) => alunosController.create(req, res, next));
router.get('/alunos/:id', (req, res, next) => alunosController.getById(req, res, next));
router.put('/alunos/:id', validateBody(studentSchema), (req, res, next) => alunosController.update(req, res, next));
